...
@flow
def first_l0_processor_with_optl(
...
def dummy_auxip_search(
    ...
    AuxipClient(rs_server_href, rs_server_api_key, None, station).search()
...
def dummy_cadip_search(
    ...
    CadipClient(rs_server_href, rs_server_api_key, None, station).search()
...
async def main_dask_task(
    ...
    with trace.use_span(main_span):
        ...
        wiki_result = requests.get('https://fr.wikipedia.org/wiki/Patrick_Balkany#Affaires_judiciaires')
